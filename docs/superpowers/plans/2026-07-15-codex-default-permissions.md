...
**Files:**
- Modify: `AGENTS.md`
- Modify: `docs/superpowers/specs/2026-07-15-codex-default-permissions-design.md`
- Modify: `docs/superpowers/plans/2026-07-15-codex-default-permissions.md`
...
```bash
git diff -- AGENTS.md docs/superpowers/specs/2026-07-15-codex-default-permissions-design.md docs/superpowers/plans/2026-07-15-codex-default-permissions.md
```
...
```bash
git add AGENTS.md docs/superpowers/specs/2026-07-15-codex-default-permissions-design.md docs/superpowers/plans/2026-07-15-codex-default-permissions.md
