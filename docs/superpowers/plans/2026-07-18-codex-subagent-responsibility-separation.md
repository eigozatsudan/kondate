...
Run: ``rg -n 'Always pass `model` explicitly|モデルまたはカスタムエージェント種別を実行環境|利用可能なカスタムエージェントを選び' AGENTS.md SubAgents.md docs/superpowers/specs/2026-07-17-codex-subagent-configuration-design.md docs/superpowers/specs/2026-07-18-codex-subagent-responsibility-separation-design.md docs/superpowers/plans/2026-07-17-codex-subagent-configuration.md docs/superpowers/plans/2026-07-17-codex-subagent-handoff.md``

Expected: 出力なし、終了コード1。

Run: `rg -n 'task_name.*証拠|選択と読み込み|custom agent種別、モデル、推論強度、permission|per-dispatch model override.*モデルだけ|推論強度.*独立|技術的read-only.*Implementer|汎用subagent' AGENTS.md SubAgents.md docs/superpowers/specs/2026-07-17-codex-subagent-configuration-design.md docs/superpowers/specs/2026-07-18-codex-subagent-responsibility-separation-design.md docs/superpowers/plans/2026-07-17-codex-subagent-configuration.md docs/superpowers/plans/2026-07-17-codex-subagent-handoff.md`

Expected: 各文書で、custom agentの選択と読み込みの確認、4制約の独立判定、`task_name`非証拠性、モデルだけに適用するsurface限定override、推論強度の独立確認、汎用subagent fallback、technical read-only未確認役とImplementerの直列化が確認できる。
