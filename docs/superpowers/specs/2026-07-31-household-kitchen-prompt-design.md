...
| 項目 | 値 |
|------|-----|
| 文書 | `docs/superpowers/specs/2026-07-31-household-kitchen-prompt-design.md` |
| 日付 | 2026-07-31 |
...
| 敵対的レビュー | `docs/superpowers/specs/2026-07-31-household-kitchen-prompt-adversarial-review.md` |
| 二次レビュー | `docs/superpowers/specs/2026-07-31-household-kitchen-prompt-secondary-review.md`（Approve） |
