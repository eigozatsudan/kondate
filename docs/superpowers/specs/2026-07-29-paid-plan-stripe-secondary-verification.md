...
- Evidence:
  ...
  - Roadmap Locked Environment Contract still 3/6/4/20 (`docs/superpowers/plans/2026-07-11-kondate-mvp-00-roadmap.md` ~L21, L315–319); design supersede table does not list roadmap env contract (~L101–111).
