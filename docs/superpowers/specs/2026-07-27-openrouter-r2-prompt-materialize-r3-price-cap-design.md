...
- 直前 R1: `docs/superpowers/specs/2026-07-27-openrouter-candidate-configuration-reslist-design.md`（Approved）
- Live 証跡: `docs/bugfix/2026-07-27-plan8-production-gate-evidence.md`（第4 / R1 ラウンド）
...
| MVP `docs/superpowers/specs/2026-07-11-kondate-mvp-design.md` | 規範 | はい（該当 $0.50） |
