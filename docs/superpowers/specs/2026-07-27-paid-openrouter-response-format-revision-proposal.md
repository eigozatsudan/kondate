...
- 対象設計書: `docs/superpowers/specs/2026-07-26-paid-openrouter-models-design.md`（§4.4 shortlist / §4.4.2 / Key Decision 5）
- 実測根拠: `docs/bugfix/2026-07-27-plan8-production-gate-evidence.md`
...
単価上限は当時 $0.50/1M（**R3 で $1.00 に改訂**）、router 禁止、exact mock 例外、privacy `2026-07-26.v1`、推奨は最大 2 本 — **すべて不変**。
