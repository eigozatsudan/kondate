...
- **Design (CURRENT revision)**: `docs/superpowers/specs/2026-07-27-openrouter-r2-prompt-materialize-r3-price-cap-design.md`
- **Prior primary**: `docs/reviews/2026-07-27-r2-r3-design-adversarial-primary.md` (Verdict: **REVISE**; C-1, I-1…I-6, M-1…M-4)
