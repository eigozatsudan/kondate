...
| 項目 | 値 |
|------|-----|
| 対象設計 | `docs/superpowers/specs/2026-07-31-generation-progress-stages-design.md`（`e7d5bd8`） |
| 一次 | `docs/reviews/2026-07-31-generation-progress-stages-design-primary.md` |
