...
- **Design path**: `docs/superpowers/specs/2026-07-27-openrouter-r2-prompt-materialize-r3-price-cap-design.md`
...
- **Cross-checked authorities**:
  ...
  - Parent: `docs/superpowers/specs/2026-07-26-paid-openrouter-models-design.md` §4.1.7 / §12 KD-8; time locks 20s/50s/22s
  - R1: `docs/superpowers/specs/2026-07-27-openrouter-candidate-configuration-reslist-design.md`
  - Evidence: `docs/bugfix/2026-07-27-plan8-production-gate-evidence.md`（第4 + R1 ラウンド）
