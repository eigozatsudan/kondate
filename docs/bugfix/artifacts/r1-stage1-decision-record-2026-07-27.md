...
設計: `docs/superpowers/specs/2026-07-27-openrouter-candidate-configuration-reslist-design.md` §5.4  
Snapshot: `docs/bugfix/artifacts/r1-models-snapshot-2026-07-27.json`

| フィールド | 値 |
|------------|-----|
| snapshotDate | 2026-07-27T14:11:04.555Z |
| survivorArtifactPath | `docs/bugfix/artifacts/r1-models-snapshot-2026-07-27.json` |
