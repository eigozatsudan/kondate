...
- 方式:
  ...
  - **第3セッション**: エンドユーザー UX 敵対レビュー（4 体一次 + 3 体二次深掘り）。観点は主婦・低 IT・片手スマホ・不安定回線。
    詳細一次/二次は `docs/reviews/2026-07-26-adversarial-ux-review.md` と
    `docs/reviews/2026-07-26-adversarial-ux-review-secondary.md`。本ファイルへは**既存 ID と実質同一でないものだけ**を
...
- **参照先の可搬性**: 第4セッションの根拠 `.superpowers/sdd/mvp-adversarial-ai-2026-07-26/**` は
  `.gitignore` 対象（git 管理外）。第3の `docs/reviews/2026-07-26-adversarial-ux-review*.md` も
...
- 設計: `docs/superpowers/specs/2026-07-11-kondate-mvp-design.md` §6
...
主基準: `docs/superpowers/specs/2026-07-22-guided-planner-optional-household-design.md`
...
既報 `docs/reviews/2026-07-25-adversarial-code-review.md` の I-3 / I-4 / Minor 1〜3 は解消済みと確認。
...
詳細: `docs/reviews/2026-07-26-adversarial-ux-review.md` /
`docs/reviews/2026-07-26-adversarial-ux-review-secondary.md`
