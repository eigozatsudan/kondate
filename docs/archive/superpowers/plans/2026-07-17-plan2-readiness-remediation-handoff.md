...
1. `AGENTS.md`
2. `SubAgents.md`
3. `docs/archive/superpowers/plans/2026-07-16-plan2-readiness-remediation.md`
4. この引継ぎ文書
...
`docs/archive/superpowers/plans/2026-07-16-plan2-readiness-remediation.md` のTask 6を、そのままTDDで実行してください。
