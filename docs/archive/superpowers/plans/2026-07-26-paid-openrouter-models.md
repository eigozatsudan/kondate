...
**仕様書:** `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md`

**二次検証反映:** `docs/archive/reviews/2026-07-26-paid-openrouter-plan-secondary-review.md`（REVISE_BEFORE_EXECUTE → 本改訂で実行可能化）
...
| ファイル | 責務 |
| --- | --- |
| `docs/archive/superpowers/specs/2026-07-11-kondate-mvp-design.md` | free-only / 旧クォータ文面を本設計へ整合 |
| `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md` | 状態を「実装中」へ（Task 1） |
| `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-00-roadmap.md` | Locked Environment Contract を有料・3/6/20 へ（Task 1） |
...
**Files:**
- Modify: `docs/archive/superpowers/specs/2026-07-11-kondate-mvp-design.md`（§11.1 モデル設定、§11.2 上限、§18 運用、受入相当 L661/L668/L678 付近）
- Modify: `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md`（状態を「実装中」へ）
- Modify: `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-00-roadmap.md`（Locked Environment Contract の free-only・5/12/45 と関連受入行）
...
`docs/archive/superpowers/plans/2026-07-11-kondate-mvp-00-roadmap.md` の次を更新:
...
```markdown
- 状態: 実装中（Plan: `docs/archive/superpowers/plans/2026-07-26-paid-openrouter-models.md`）
```
...
```bash
git diff -- docs/archive/superpowers/specs/2026-07-11-kondate-mvp-design.md docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md docs/archive/superpowers/plans/2026-07-11-kondate-mvp-00-roadmap.md CLAUDE.md
```
...
```bash
git add docs/archive/superpowers/specs/2026-07-11-kondate-mvp-design.md docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md docs/archive/superpowers/plans/2026-07-11-kondate-mvp-00-roadmap.md CLAUDE.md
...
Plan revised after secondary review and saved to `docs/archive/superpowers/plans/2026-07-26-paid-openrouter-models.md`.
