...
if rg -n 'Plan 2 owns only.*confirm_menu_label_confirmation|confirm_menu_label_confirmation\(menu_id, ?confirmation_id\)|has_function_privilege.*confirm_menu_label_confirmation' \
  docs/archive/superpowers/plans/2026-07-11-kondate-mvp-02-menu-domain-pantry.md; then exit 1; fi
rg -n 'source_text_snapshot|exposes no confirmation transition|three-argument' \
  docs/archive/superpowers/plans/2026-07-11-kondate-mvp-02-menu-domain-pantry.md
```
...
rg -n 'source_text_snapshot|confirm_menu_label_confirmation\(uuid,uuid,text\)|lock_and_assert_current_safety_fingerprint' \
  docs/archive/superpowers/plans/2026-07-11-kondate-mvp-03-ai-generation-results.md
if rg -n 'sourceText\.get\(canonical\.sourcePath\)|confirm_menu_label_confirmation\(uuid,uuid\)' \
  docs/archive/superpowers/plans/2026-07-11-kondate-mvp-03-ai-generation-results.md; then exit 1; fi
```
...
```bash
git add docs/archive/superpowers/plans/2026-07-11-kondate-mvp-03-ai-generation-results.md
...
**Files:**
- Modify: `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-04-history-regeneration.md`
...
rg -n 'source_text_snapshot|reuses.*three-argument|sourceTextSnapshot' \
  docs/archive/superpowers/plans/2026-07-11-kondate-mvp-04-history-regeneration.md
if rg -n "Drop/revoke Plan 2's two-argument|resolve .*sourceText through .*collectMenuTextSources" \
  docs/archive/superpowers/plans/2026-07-11-kondate-mvp-04-history-regeneration.md; then exit 1; fi
```
...
```bash
git add docs/archive/superpowers/plans/2026-07-11-kondate-mvp-04-history-regeneration.md
