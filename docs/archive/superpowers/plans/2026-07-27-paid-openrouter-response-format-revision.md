...
- Authority: `docs/archive/superpowers/specs/2026-07-27-paid-openrouter-response-format-revision-proposal.md`
- Parent design: `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md`
...
- Modify: `scripts/benchmark-paid-openrouter-models.mjs`
- Modify: `scripts/benchmark-paid-openrouter-models.test.mjs`
- Modify: `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md`
...
**Files:**
- Modify: `docs/archive/bugfix/2026-07-27-plan8-production-gate-evidence.md`
...
```bash
git add docs/archive/bugfix/2026-07-27-plan8-production-gate-evidence.md README.md docs/runbooks/openrouter.md .superpowers/sdd/progress.md
...
```bash
git add docs/archive/bugfix/2026-07-27-plan8-production-gate-evidence.md .superpowers/sdd/progress.md
