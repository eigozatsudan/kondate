...
**仕様書:** `docs/archive/superpowers/specs/2026-07-30-shopping-from-history-and-cleanup-design.md`（Approved R2+L15）  
**計画レビュー:** `docs/archive/reviews/2026-07-30-shopping-from-history-plan-adversarial.md` → **本版 r1 で Critical/Important を吸収**
...
Plan r1 saved to `docs/archive/superpowers/plans/2026-07-30-shopping-from-history-and-cleanup.md`.
