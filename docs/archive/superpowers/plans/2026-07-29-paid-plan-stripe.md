...
**Plan revision:** r2 — external Codex review（`docs/archive/superpowers/plans/2026-07-29-paid-plan-stripe-external-review-codex-gpt5.md`）の open 6 件を計画修正（companion: `docs/archive/superpowers/plans/2026-07-29-paid-plan-stripe-plan-fix-r2-external-codex.md`）。r1: adversarial + crosscheck + secondary must_fix（`docs/archive/superpowers/plans/2026-07-29-paid-plan-stripe-plan-fix-r1.md`）。

## Global Constraints

- **設計正本:** `docs/archive/superpowers/specs/2026-07-29-paid-plan-stripe-design.md`（Review-ready r2）。矛盾時は設計が MVP / Plan 8 / freemium / コピー簡素化の課金・枠関連を supersede。
...
Companion: `docs/archive/superpowers/plans/2026-07-29-paid-plan-stripe-plan-fix-r2-external-codex.md`
...
Companion: `docs/archive/superpowers/plans/2026-07-29-paid-plan-stripe-plan-fix-r1.md`
...
*End of plan. Authority: `docs/archive/superpowers/specs/2026-07-29-paid-plan-stripe-design.md` r2. Codebase anchors: `/tmp/grok-1000/paid-plan-codebase-inventory.md`. Plan revision: r2.*
