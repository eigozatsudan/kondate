...
> **2026-07-18同期:** Task 2とTask 3は、`docs/archive/superpowers/specs/2026-07-18-codex-subagent-responsibility-separation-design.md` に基づき、surface capability別の責任分離へ改訂した。
...
- 既存の未コミット変更 `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-02-menu-domain-pantry.md` を変更、ステージ、コミットしない。
