...
- Preserve the existing uncommitted change in `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-02-menu-domain-pantry.md`; integrate it deliberately in Task 7 and never discard it.
...
docs/archive/superpowers/plans/{2026-07-11-kondate-mvp-02-menu-domain-pantry.md,2026-07-11-kondate-mvp-03-ai-generation-results.md}
```
...
- Modify: `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-03-ai-generation-results.md`
...
```bash
rg -n 'detectUnsupportedMedicalRequest\(submission\.memo\)|detectUnsupportedMedicalRequest\(value\.memo\)' src shared netlify/functions docs/archive/superpowers/plans/2026-07-11-kondate-mvp-03-ai-generation-results.md
```
...
```bash
git add shared/contracts/planner.ts shared/contracts/planner.test.ts shared/safety/validate-generated-menu.test.ts src/features/planner/planner-page.tsx src/features/planner/planner-page.test.tsx docs/archive/superpowers/plans/2026-07-11-kondate-mvp-03-ai-generation-results.md
...
- Modify: `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-02-menu-domain-pantry.md`
...
```bash
git add docs/archive/superpowers/plans/2026-07-11-kondate-mvp-02-menu-domain-pantry.md
