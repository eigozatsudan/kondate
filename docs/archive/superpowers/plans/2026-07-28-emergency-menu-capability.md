...
**Spec (authoritative):** `docs/archive/superpowers/specs/2026-07-28-emergency-menu-capability-design.md` (human sign-off 2026-07-28). Supersedes Plan 7 §4.2 / §209 idea empty-only contract; MVP §9.3 remains absolute for `path=household`.
...
`docs/archive/superpowers/plans/2026-07-28-emergency-menu-capability.md`
