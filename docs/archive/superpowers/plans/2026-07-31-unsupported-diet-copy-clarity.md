...
**仕様書:** `docs/archive/superpowers/specs/2026-07-31-unsupported-diet-copy-clarity-design.md`（Approved r2）  
**敵対的レビュー:** `docs/archive/superpowers/specs/2026-07-31-unsupported-diet-copy-clarity-adversarial-review.md`（I1–I7 / M1–M3 addressed）
...
Plan complete and saved to `docs/archive/superpowers/plans/2026-07-31-unsupported-diet-copy-clarity.md`.
