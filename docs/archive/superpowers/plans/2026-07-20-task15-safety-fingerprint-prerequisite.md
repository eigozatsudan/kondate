...
- 正本 `docs/archive/superpowers/plans/2026-07-11-kondate-mvp-03-ai-generation-results.md` の2 helper bodyとREVOKEを文字単位で使用し、alternate serializerや別builderを作らない。
