...
- 設計の正本は `docs/archive/superpowers/specs/2026-07-17-playwright-mcp-setup-design.md` と `docs/archive/superpowers/specs/2026-07-17-browser-entrypoint-fix-design.md` とする。
...
- Verify: `docs/archive/superpowers/specs/2026-07-17-playwright-mcp-setup-design.md`
- Verify: `docs/archive/superpowers/specs/2026-07-17-browser-entrypoint-fix-design.md`
