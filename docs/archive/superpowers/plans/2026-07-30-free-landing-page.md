...
**仕様書:** `docs/archive/superpowers/specs/2026-07-30-free-landing-page-design.md`（Review-ready / R1 反映済み）  
**対比:** `docs/archive/superpowers/specs/2026-07-30-plus-landing-page-design.md`（混同禁止）
...
Plan complete and saved to `docs/archive/superpowers/plans/2026-07-30-free-landing-page.md`.
