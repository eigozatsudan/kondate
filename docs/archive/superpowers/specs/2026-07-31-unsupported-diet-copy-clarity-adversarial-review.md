...
**Document:** `docs/archive/superpowers/specs/2026-07-31-unsupported-diet-copy-clarity-design.md`  
...
- **Status:** addressed in design r2（§10）

### M2. 箇条書きのマークアップ未指定

§5.2 は文言のみ。§5.3 に「意味のあるリスト（`ul`/`li`）で出す」を1行。

- **Status:** addressed in design r2（§5.2 / §5.3）
...
- **Status:** addressed in design r2（§12）
