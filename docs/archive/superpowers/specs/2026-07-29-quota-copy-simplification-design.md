...
| 項目 | 値 |
|------|-----|
| 文書 | `docs/archive/superpowers/specs/2026-07-29-quota-copy-simplification-design.md` |
| 日付 | 2026-07-29 |
...
| レビュー | 方針 ADV（セッション）; 設計書敵対的 `docs/archive/reviews/2026-07-29-quota-copy-simplification-design-adversarial.md`（D-C1〜 / 再生成 **案 A**） |
