...
| 項目 | 値 |
|------|-----|
| 文書 | `docs/archive/superpowers/specs/2026-07-29-paid-plan-stripe-design.md` |
| 日付 | 2026-07-29 |
...
| レビュー | `docs/archive/superpowers/specs/2026-07-29-paid-plan-stripe-primary-adversarial-review.md`、`docs/archive/superpowers/specs/2026-07-29-paid-plan-stripe-secondary-verification.md` |
| 著者 | （プレースホルダ） |
...
- `docs/archive/superpowers/specs/2026-07-11-kondate-mvp-design.md` — クォータ・プライバシー・旧非目標
- `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md` — 有料 allowlist・3/6/20
- `docs/archive/superpowers/specs/2026-07-28-season-freemium-quota-design.md` — identity 台帳・無料版は・AI_QUOTA_DISABLED
- `docs/archive/superpowers/specs/2026-07-29-quota-copy-simplification-design.md` — 低リテラシー残数表示
