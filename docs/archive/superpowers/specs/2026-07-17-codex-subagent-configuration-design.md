...
この同期では `.codex/config.toml` と `.codex/agents/*.toml` を変更しない。責任分離の正本は `docs/archive/superpowers/specs/2026-07-18-codex-subagent-responsibility-separation-design.md` とする。
