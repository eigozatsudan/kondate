...
- 敵対レビュー:
  - 一次/二次: `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-primary.md` /
    `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-secondary.md`（REVISE）
  - 再レビュー一次/二次: `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-rereview-primary.md` /
    `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-rereview-secondary.md`（APPROVE_WITH_NITS → nits 本節で閉鎖）
- 対象設計書: `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md`
  （§4.4 shortlist / §4.4.1 / §4.4.2 / §12 Key Decision 5）
- 実装完了ゲート証跡: `docs/archive/bugfix/2026-07-27-plan8-production-gate-evidence.md`（**第4ラウンド**が現行正本）
- 直前 Plan クローズ: `docs/archive/bugfix/2026-07-27-plan8-response-format-revision-closeout.md`
- 直前改訂（実装済み）: `docs/archive/superpowers/specs/2026-07-27-paid-openrouter-response-format-revision-proposal.md`
...
4. コミット可能な survivor 成果物を作る（KD-R1-17）:
   - パス例: `docs/archive/bugfix/artifacts/r1-models-snapshot-D.json`（または同等の tracked 表）  
...
| survivor 成果物 | `docs/archive/bugfix/artifacts/`（例） | snapshot D の closed survivor 表 |
...
- 証跡ドキュメント更新パス:
  - 追記先: `docs/archive/bugfix/2026-07-27-plan8-production-gate-evidence.md` に **「R1 ラウンド」** 節を追加（第4 を上書きしない）。
...
- 親設計: `docs/archive/superpowers/specs/2026-07-26-paid-openrouter-models-design.md` §4.4 / §4.4.1 / §4.4.2 / §12
- response-format 改訂案: `docs/archive/superpowers/specs/2026-07-27-paid-openrouter-response-format-revision-proposal.md`
- Live 証跡: `docs/archive/bugfix/2026-07-27-plan8-production-gate-evidence.md`（第1–4 ラウンド）
- Closeout: `docs/archive/bugfix/2026-07-27-plan8-response-format-revision-closeout.md`（R1 定義）
...
- 敵対レビュー一次: `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-primary.md`
- 敵対レビュー二次: `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-secondary.md`
- 敵対再レビュー一次: `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-rereview-primary.md`
- 敵対再レビュー二次: `docs/archive/reviews/2026-07-27-r1-candidate-reslist-adversarial-rereview-secondary.md`
