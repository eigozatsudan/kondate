...
| 項目 | 値 |
|------|-----|
| 対象 | `docs/archive/superpowers/plans/2026-07-31-household-kitchen-prompt.md`（r1） |
| 一次 | `docs/archive/reviews/2026-07-31-household-kitchen-prompt-plan-primary.md` |
