...
| 項目 | 値 |
|------|-----|
| 対象 | `docs/archive/superpowers/plans/2026-07-31-onboarding-multi-member-attention.md`（初版〜`4348310`） |
| 設計 | `docs/archive/superpowers/specs/2026-07-31-onboarding-multi-member-attention-design.md` |
| 日付 | 2026-07-31 |
