...
2026-07-25 のコード／セキュリティ向け敵対的レビュー（`docs/archive/reviews/2026-07-25-adversarial-code-review.md`）とは別軸。重複する場合は UX 影響を優先して記載。

設計アンカー: `docs/archive/superpowers/specs/2026-07-11-kondate-mvp-design.md` §1 成功条件・§10 UI/UX、`2026-07-22-guided-planner-optional-household-design.md`。
...
**二次深掘り:** `docs/archive/reviews/2026-07-26-adversarial-ux-review-secondary.md`  
