...
select ok(
  coalesce(has_function_privilege('authenticated', to_regprocedure('public.save_generation_draft(bigint,text,text[],text,text,uuid[],smallint,smallint,text,text,text[],text,jsonb)'), 'EXECUTE'), false)
  and not coalesce(has_function_privilege('anon', to_regprocedure('public.save_generation_draft(bigint,text,text[],text,text,uuid[],smallint,smallint,text,text,text[],text,jsonb)'), 'EXECUTE'), false)
  and not coalesce(has_function_privilege('service_role', to_regprocedure('public.save_generation_draft(bigint,text,text[],text,text,uuid[],smallint,smallint,text,text,text[],text,jsonb)'), 'EXECUTE'), false),
...
select public.save_generation_draft(
  ...
  15::smallint, 'economy',null, array[]::text[], '', '[]'::jsonb
);
...
select throws_ok(
  $$select public.save_generation_draft(null,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '22023', 'invalid_draft_save', 'NULL expected revision is invalid'
);
select throws_ok(
  $$select public.save_generation_draft(-1,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '22023', 'invalid_draft_save', 'negative expected revision is invalid'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[null::text],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'main ingredients reject NULL elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[['鶏肉']]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'main ingredients reject multidimensional arrays'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array['   ']::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'main ingredients reject blank elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[U&'\00A0鶏肉\FEFF']::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'main ingredients reject Unicode padding'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[repeat('🍳',81)]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'main ingredients reject elements above 80 code points'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,'household',array[null::uuid],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'target members reject NULL elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,'household',array[['20000000-0000-0000-0000-000000000001'::uuid]],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'target members reject multidimensional arrays'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[null::text],'','[]'::jsonb)$$,
  '23514', null, 'avoid ingredients reject NULL elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[['乳']]::text[],'','[]'::jsonb)$$,
  '23514', null, 'avoid ingredients reject multidimensional arrays'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[U&'\2028乳']::text[],'','[]'::jsonb)$$,
  '23514', null, 'avoid ingredients reject Unicode padding'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[repeat('x',81)]::text[],'','[]'::jsonb)$$,
  '23514', null, 'avoid ingredients reject overlong elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],U&'\FEFFmemo','[]'::jsonb)$$,
  '23514', null, 'memo rejects non-canonical padding'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],repeat('🍳',201),'[]'::jsonb)$$,
...
select throws_ok(
  $$select public.save_generation_draft(1,null,array(select '食材' || i from generate_series(1,9) as values_(i)),null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'main ingredient count rejects nine'
);
select throws_ok(
  $$select public.save_generation_draft(1,null,array[]::text[],null,'household',array(select ('22000000-0000-0000-0000-' || lpad(i::text,12,'0'))::uuid from generate_series(1,21) as values_(i)),null::smallint,null,null,null,array[]::text[],'','[]'::jsonb)$$,
  '23514', null, 'target member count rejects twenty-one'
);
select throws_ok(
  $$select public.save_generation_draft(1,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array(select '回避' || i from generate_series(1,21) as values_(i)),'','[]'::jsonb)$$,
  '23514', null, 'avoid ingredient count rejects twenty-one'
);
select throws_ok(
  $$select public.save_generation_draft(1,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'', (select jsonb_agg(jsonb_build_object('pantryItemId',('23000000-0000-0000-0000-' || lpad(i::text,12,'0'))::uuid,'priority','must_use')) from generate_series(1,51) as values_(i)))$$,
...
select is(
  (public.save_generation_draft(0,'dinner',array['再作成'],'japanese',null,array[]::uuid[],null::smallint,30::smallint,'standard',null,array[]::text[],'','[]'::jsonb)).revision,
  4::bigint,
  'recreation continues the tombstone revision'
);
select throws_ok(
  $$select public.save_generation_draft(2,'dinner',array['古い画面'],'japanese',null,array[]::uuid[],null::smallint,30::smallint,'standard',null,array[]::text[],'','[]'::jsonb)$$,
