...
select public.save_generation_draft(
  ...
  15::smallint, 'economy',null, array[]::text[], '', '[]'::jsonb,null
);
...
select throws_ok(
  $$select public.save_generation_draft(null,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '22023', 'invalid_draft_save', 'NULL expected revision is invalid'
);
select throws_ok(
  $$select public.save_generation_draft(-1,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '22023', 'invalid_draft_save', 'negative expected revision is invalid'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[null::text],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'main ingredients reject NULL elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[['鶏肉']]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'main ingredients reject multidimensional arrays'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array['   ']::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'main ingredients reject blank elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[U&'\00A0鶏肉\FEFF']::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'main ingredients reject Unicode padding'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[repeat('🍳',81)]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'main ingredients reject elements above 80 code points'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,'household',array[null::uuid],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'target members reject NULL elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,'household',array[['20000000-0000-0000-0000-000000000001'::uuid]],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'target members reject multidimensional arrays'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[null::text],'','[]'::jsonb,null)$$,
  '23514', null, 'avoid ingredients reject NULL elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[['乳']]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'avoid ingredients reject multidimensional arrays'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[U&'\2028乳']::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'avoid ingredients reject Unicode padding'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[repeat('x',81)]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'avoid ingredients reject overlong elements'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],U&'\FEFFmemo','[]'::jsonb,null)$$,
  '23514', null, 'memo rejects non-canonical padding'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],repeat('🍳',201),'[]'::jsonb,null)$$,
...
select is(
  (public.save_generation_draft(
    ...
    null::smallint,
    null, null,null, array(select '避ける' || i from generate_series(1,20) as values_(i)), repeat('🍳',200),
    (select jsonb_agg(jsonb_build_object('pantryItemId',('21000000-0000-0000-0000-' || lpad(i::text,12,'0'))::uuid,'priority','prefer_use')) from generate_series(1,50) as values_(i)),null
  )).revision,
  1::bigint,
...
select throws_ok(
  $$select public.save_generation_draft(1,null,array(select '食材' || i from generate_series(1,9) as values_(i)),null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'main ingredient count rejects nine'
);
select throws_ok(
  $$select public.save_generation_draft(1,null,array[]::text[],null,'household',array(select ('22000000-0000-0000-0000-' || lpad(i::text,12,'0'))::uuid from generate_series(1,21) as values_(i)),null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
  '23514', null, 'target member count rejects twenty-one'
);
select throws_ok(
  $$select public.save_generation_draft(1,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array(select '回避' || i from generate_series(1,21) as values_(i)),'','[]'::jsonb,null)$$,
  '23514', null, 'avoid ingredient count rejects twenty-one'
);
select throws_ok(
  $$select public.save_generation_draft(1,null,array[]::text[],null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'', (select jsonb_agg(jsonb_build_object('pantryItemId',('23000000-0000-0000-0000-' || lpad(i::text,12,'0'))::uuid,'priority','must_use')) from generate_series(1,51) as values_(i)),null)$$,
...
select is(
  (public.save_generation_draft(
    ...
    '[{"pantryItemId":"21000000-0000-0000-0000-000000000001","priority":"must_use"}]'::jsonb,null
  )).revision,
  2::bigint,
...
select throws_ok(
  $$select public.save_generation_draft(2,'dinner',array['鶏肉'],'japanese',null,array[]::uuid[],null::smallint,30::smallint,'standard','plenty',array[]::text[],'','[]'::jsonb,null)$$,
  '22023', 'invalid_draft_save',
  'ingredient preference rejects undeclared values'
);
select throws_ok(
  $$select public.save_generation_draft(0,null,null,null,null,array[]::uuid[],null::smallint,null,null,null,array[]::text[],'','[]'::jsonb,null)$$,
...
select is(
  (public.save_generation_draft(0,'dinner',array['再作成'],'japanese',null,array[]::uuid[],null::smallint,30::smallint,'standard',null,array[]::text[],'','[]'::jsonb,null)).revision,
  4::bigint,
  'recreation continues the tombstone revision'
);
select throws_ok(
  $$select public.save_generation_draft(2,'dinner',array['古い画面'],'japanese',null,array[]::uuid[],null::smallint,30::smallint,'standard',null,array[]::text[],'','[]'::jsonb,null)$$,
