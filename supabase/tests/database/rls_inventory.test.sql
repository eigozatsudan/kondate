...
select is_empty(
  ...
  ('public.acquire_account_delete_lock(p_user_id uuid, p_lock_token text, p_expires_at timestamp with time zone)', 'service_role', 'EXECUTE'),
  ...
  ('public.release_account_delete_lock(p_user_id uuid, p_lock_token text)', 'service_role', 'EXECUTE'),
  ...
  ('public.reserve_flyer_weekly(p_user_id uuid, p_identity_key text, p_idempotency_key text, p_attempt_limit integer, p_short_window_limit integer, p_global_limit integer, p_quota_disabled boolean, p_now timestamp with time zone, p_stale_after_seconds integer)', 'service_role', 'EXECUTE'),
  ...
  ('public.put_weekly_plan_intent(p_request_id uuid, p_user_id uuid, p_snapshot jsonb, p_fingerprint text)', 'service_role', 'EXECUTE'),
  ('public.get_weekly_plan_intent(p_request_id uuid, p_user_id uuid)', 'service_role', 'EXECUTE'),
  ('public.delete_weekly_plan_intent(p_request_id uuid)', 'service_role', 'EXECUTE'),
  ...
  ('public.get_taste_signals(p_now timestamp with time zone)', 'authenticated', 'EXECUTE'),
  ('public.get_taste_signals(p_now timestamp with time zone)', 'service_role', 'EXECUTE'),
  ('public.set_taste_learning_enabled(p_enabled boolean, p_expected_seq bigint)', 'authenticated', 'EXECUTE'),
  ('public.set_taste_learning_enabled(p_enabled boolean, p_expected_seq bigint)', 'service_role', 'EXECUTE'),
