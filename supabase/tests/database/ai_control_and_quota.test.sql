...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    'generation-command.v2', repeat('9', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 6, 6, 4, 20, false, 180,
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    'new_menu', null, null, null, null, null,
    'generation-command.v0', repeat('9', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 3, 6, 4, 20, false, 180,
    '2026-07-10 15:00:00+00'
  )
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    '20000000-0000-4000-8000-000000000096',
    'new_menu', null, null, null, null, null,
    'generation-command.v2', repeat('g', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 3, 6, 4, 20, false, 180,
    '2026-07-10 15:00:00+00'
  )
$$, '22023', 'invalid_request_hmac',
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    'generation-command.v2', repeat('7', 64), '{"kind":"regenerate_menu","target_mode":"household","servings":2,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":1}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 0, false, 180,
    '2026-07-10 15:00:00+00'
  )
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    '20000000-0000-4000-8000-000000000098',
    'regenerate_menu', null, null, null, null, null,
    'generation-command.v2', repeat('8', 64), '{"kind":"regenerate_menu","target_mode":"household","servings":2,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":1}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 201, false, 180,
    '2026-07-10 15:00:00+00'
  )
$$, '22023', 'invalid_quota_configuration',
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    null, null, null, 'generation-command.v2', repeat('1', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    null, null, null, 'generation-command.v2', repeat('2', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
$$, 'P0001', 'draft_unavailable',
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    null, null, null, 'generation-command.v2', repeat('3', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
$$, 'P0001', 'draft_unavailable',
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    null, null, null, 'generation-command.v2', repeat('4', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
$$, 'P0001', 'draft_unavailable',
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    null, null, null, 'generation-command.v2', repeat('5', 64), '{"kind":"regenerate_menu","target_mode":"household","servings":2,"target_member_ids":["10000000-0000-4000-8000-000000000002"],"source_menu_version":1}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    'new_menu', '30000000-0000-4000-8000-000000000002', 2,
    null, null, null, 'generation-command.v2', repeat('a', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000002"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
...
select lives_ok($$
  select public.reserve_ai_generation(
    ...
    'new_menu', '30000000-0000-4000-8000-000000000002', 2,
    null, null, null, 'generation-command.v2', repeat('f', 64), '{"kind":"new_menu","target_mode":"idea","servings":2,"target_member_ids":[],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
...
select throws_ok($$
  select public.reserve_ai_generation(
    ...
    'new_menu', '30000000-0000-4000-8000-000000000002', 2,
    null, null, null, 'generation-command.v2', repeat('b', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000002"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
  )
$$, 'P0001', 'draft_revision_conflict',
...
select is(
  public.reserve_ai_generation(
    ...
    'new_menu', '30000000-0000-4000-8000-000000000001', 1,
    null, null, null, 'generation-command.v2', repeat('1', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 15:00:00+00'
  )->>'status',
  'processing'
);
select is(
...
select is(
  public.reserve_ai_generation(
    ...
    '20000000-0000-4000-8000-000000000001',
    'new_menu', '30000000-0000-4000-8000-000000000001', 1,
    null, null, null, 'generation-command.v2', repeat('1', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 15:00:01+00'
  )->>'replayed',
  'true'
);
...
select is(
  (
    select public.reserve_ai_generation(
      ...
      'new_menu', '30000000-0000-4000-8000-000000000001', 1,
      null, null, null,
      'generation-command.v2', repeat('2', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 15:00:02+00'
    )
...
select is(
  public.reserve_ai_generation(
    ...
    null, null, null, 'generation-command.v2', repeat('3', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000002"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000002'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 15:10:00+00'
  )->>'status',
  'processing',
...
begin
  ...
  begin
    perform public.reserve_ai_generation(
      ...
      null, null, null, 'generation-command.v2', repeat('c', 64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 3, 6, 4, 20, false, 180, '2026-07-10 16:00:00+00'
    );
...
begin
  ...
  begin
    perform public.reserve_ai_generation(
      ...
      null,null,null,'generation-command.v2',repeat('a',64), '{"kind":"new_menu","target_mode":"household","servings":null,"target_member_ids":["10000000-0000-4000-8000-000000000001"],"source_menu_version":null}'::jsonb, tests.quota_identity_key('10000000-0000-4000-8000-000000000001'::uuid), 3, 6, 4, 20, false, 180,'2026-07-11 00:00:00+00');
...
begin
  ...
  perform public.reserve_ai_generation(v_owner,'30000000-0000-4000-8000-000000000080',
    ...
    ), tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-11 00:00:10+00');
  ...
  perform public.reserve_ai_generation(v_owner,'30000000-0000-4000-8000-000000000081',
    ...
    'generation-command.v2',repeat('b',64), jsonb_build_object(
      ...
      'target_member_ids', to_jsonb(v_draft.target_member_ids),
      'source_menu_version', null
    ),tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-12 00:01:00+00');
  select id into strict v_request_id from private.ai_generation_requests
  ...
  perform public.reserve_ai_generation(v_owner,'30000000-0000-4000-8000-000000000082',
    ...
    'generation-command.v2',repeat('c',64), jsonb_build_object(
      ...
      'target_member_ids', to_jsonb(v_draft.target_member_ids),
      'source_menu_version', null
    ),tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-12 00:02:00+00');
  select id into strict v_request_id from private.ai_generation_requests
  ...
  perform pg_temp.finalize_ordering_success(v_request_id,
    ...
    v_pantry_item,'2026-07-12 00:01:59+00','2026-07-12 00:02:02+00');
  ...
  perform public.reserve_ai_generation(v_owner,'30000000-0000-4000-8000-000000000083',
    ...
    'generation-command.v2',repeat('d',64), jsonb_build_object(
      ...
      'target_member_ids', to_jsonb(v_draft.target_member_ids),
      'source_menu_version', null
    ),tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-11 00:03:00+00');
  select id into strict v_request_id from private.ai_generation_requests
  ...
  -- 日次上限 3: 同日は 080+083+084 の 3 枠。独立ケース 081/082 は翌日 JST へ分離済み。
  v_before_revision := v_draft.revision;
  perform public.reserve_ai_generation(v_owner,'30000000-0000-4000-8000-000000000084',
    ...
    ),tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-11 00:14:00+00');
  select id into strict v_request_id from private.ai_generation_requests
...
begin
  ...
  v_payload := public.reserve_ai_generation(
    ...
    tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180, '2026-07-11 01:00:00+00'
  );
  ...
  for v_i in 1..4 loop
    ...
    v_payload := public.reserve_ai_generation(
      ...
      tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180, '2026-07-11 02:00:00+00'
    );
    if v_payload->>'status' is distinct from 'processing' then
  ...
  v_payload := public.reserve_ai_generation(
    ...
    tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180, '2026-07-11 02:00:20+00'
  );
  if v_payload->>'status' is distinct from 'processing' then
...
begin
  ...
  if v_success_consumed + v_success_remaining <> 3 then
...
begin
  ...
  if (v_usage->'success'->>'consumed')::integer <> 0
     ...
     or (v_usage->'success'->>'limit')::integer <> 3 then
...
begin
  ...
  perform public.reserve_ai_generation(
    ...
    tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180, v_now
  );
...
begin
  ...
  loop
    ...
    perform public.reserve_ai_generation(
      ...
      tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-11 02:10:00+00'
    );
    select id into strict v_request_id
    from private.ai_generation_requests
...
begin
  ...
  perform public.reserve_ai_generation(
    ...
    tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-11 03:00:00+00'
  );
  select id into strict v_request_id
  from private.ai_generation_requests
  where user_id = v_owner
...
begin
  ...
  foreach v_case in array array['rename', 'delete'] loop
    ...
    perform public.reserve_ai_generation(
      ...
      tests.quota_identity_key(v_owner), 3, 6, 4, 20, false, 180,'2026-07-11 04:00:00+00'
    );
    select id into strict v_request_id
    from private.ai_generation_requests
    where user_id = v_owner
