  ...
  if p_expected_revision = 0 then
    ...
    if not v_has_existing then
      insert into public.generation_drafts (
        ...
        novelty_preference, avoid_ingredients, memo, pantry_selections, revision
      ) values (
        ...
        p_ingredient_preference, p_novelty_preference,
      ...
      set meal_type = p_meal_type,
        ...
        novelty_preference = p_novelty_preference,
...
-- reserve: submission snapshot へ novelty_preference を写す
...
-- submission snapshot 戻り値に novelty_preference を追加
