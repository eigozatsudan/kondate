-- SHOP7 (adversarial-quality-pass-1250d8a0):
-- apply_shopping_reconciliation が list 全体の shopping_current_label_warnings を
-- 消すと、multi-source で未対象 source の現行投影まで欠落する。
-- provenance の list-level confirmations と同様、対象 derivation group だけ消す。
