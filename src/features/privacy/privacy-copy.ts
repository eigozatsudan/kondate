...
export const privacySections = [
  {
    title: "AIへ送る情報",
    body: "献立の希望や人数など、家族の有無に関わらず共通で送る内容に加え、家族設定を使う場合だけ年齢帯、食べる量、アレルギー、安全上の配慮、苦手な食材を、「家族1」のような仮の番号に置き換えて送ります。家族設定を使わないアイデア献立では、家族に関する情報は一切送りません。新しい献立を作るときは、同じ料理が続かないよう、直近の献立（最大10献立）の料理名も送ります。また、好みの学習をONにしている場合は、★を付けた献立や選んだ献立から読み取った料理名と食材名、および直近で繰り返し指定したメイン食材名（最長90日・最大50献立）も送ります。好みの学習は設定でいつでも止められます。",
  },
  {
    title: "AIへ送らない情報",
