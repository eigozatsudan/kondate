/**
 * メイン食材の正規化と canonical 比較、およびよく使う食材の静的候補。
 * 自由入力・冷蔵庫候補・クイック選択チップが同じ規則で追加・重複判定・解除できるよう
 * 共通化する。部分一致や同義語変換は行わない。
 */

/**
 * Gate 0 で人間が承認した初期候補と表示順。
 * アレルゲン／安全カタログとは別物。エージェントが勝手に増減・並べ替えしない。
 */
